...
public class Prof2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendbutton = findViewById(R.id.activity_prof2_button);
        sendbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_SEND);
                intent.setData(Uri.parse("mailto:"));
                subject = findViewById(R.id.activity_prof2_editText);
                body = findViewById(R.id.activity_prof2_editText2);
   ...
   /*             String[] to1 = new String[10] ;
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, "prof2@gmail.com");
