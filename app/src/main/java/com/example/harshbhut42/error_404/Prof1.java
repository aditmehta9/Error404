...
public class Prof1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendbutton = findViewById(R.id.activity_prof1_button);
        sendbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_SEND);
                intent.setData(Uri.parse("mailto:"));
                subject = findViewById(R.id.activity_prof1_editText);
                body = findViewById(R.id.activity_prof1_editText2);
               ...
               /* for(int i=1;i<=50;i++) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, "prof1@gmail.com");
