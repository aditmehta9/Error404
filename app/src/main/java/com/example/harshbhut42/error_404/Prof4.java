...
public class Prof4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prof4);
        sendbutton = findViewById(R.id.activity_prof4_button);
        sendbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_SEND);
                intent.setData(Uri.parse("mailto:"));
                subject = findViewById(R.id.activity_prof4_editText);
                body = findViewById(R.id.activity_prof4_editText2);
   ...
   /*             String[] to1 = new String[10] ;
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, "prof4@gmail.com");
